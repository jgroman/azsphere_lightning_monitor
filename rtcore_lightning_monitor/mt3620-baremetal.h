...
/// <summary>
///     Base address of System Control Block, ARM DDI 0403E.b S3.2.2.
/// </summary>
static const uintptr_t SCB_BASE = 0xE000ED00;

/// <summary>
///     Base address of NVIC Set-Enable Registers, ARM DDI 0403E.b S3.4.3.
/// </summary>
static const uintptr_t NVIC_ISER_BASE = 0xE000E100;

/// <summary>
///     Base address of NVIC Interrupt Priority Registers, 
///     ARM DDI 0403E.b S3.4.3.
/// </summary>
static const uintptr_t NVIC_IPR_BASE = 0xE000E400;

/// <summary>
///     The IOM4 cores on the MT3620 use three bits to encode interrupt 
///     priorities.
/// </summary>
...
/// <summary>
///     Write the supplied 8-bit value to an address formed from the supplied 
///     base address and offset.
/// </summary>
/// <param name="baseAddr">Typically the start of a register bank.</param>
/// <param name="offset">
///     This value is added to the base address to form the target address.
///     It is typically the offset of a register within a bank.
/// </param>
