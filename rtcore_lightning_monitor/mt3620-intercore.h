...
/// <summary>
///     Remove data from the shared buffer, which has been written by 
///     the high-level application.
/// </summary>
/// <param name="outbound">
///     The outbound buffer, as obtained from <see cref="GetIntercoreBuffers" />.
/// </param>
/// <param name="inbound">
///     The inbound buffer, as obtained from <see cref="GetIntercoreBuffers" />.
/// </param>
...
/// <param name="dataSize">
///     On entry, contains maximum size of destination buffer in bytes.
///     On exit, contains the actual number of bytes which were written to 
///     the destination buffer.
/// </param>
/// <returns>0 if able to dequeue the data, -1 otherwise.</returns>
int 
DequeueData(BufferHeader *outbound, BufferHeader *inbound, uint32_t bufSize, 
                void *dest, uint32_t *dataSize);
